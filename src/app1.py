...
app.layout = dbc.Container([
    ...
    html.Div([
        ...
        html.Div([
            html.H1(
            [
            html.Span("Pandemic Impact"),
            html.Br(),
            html.Span("Monitor")
                ]),
            html.P("A data-driven project aimed at tracking and analyzing the economic resilience of various countries in the wake of the COVID-19 pandemic and other significant global events.")     
            ],
            style={
...
''' 
Now u have the styling, next is to make it interactive...u add 3 pages in the buttons so it can be seen
'''
